...
kApiKey = os.getenv("TEST_NVCF_API_KEY", "xxxxx")
assert kApiKey, "Generate API_KEY and export TEST_NVCF_API_KEY=xxxxx"
...
if __name__ == "__main__":
    ...
    response=chat_with_media_nvcf(invoke_url, media_samples, query, stream)
